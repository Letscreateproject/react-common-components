        ...
        return (
            ...
            <div className="details-container">
                ...
                <h2 className='head'>BASIC INFORMATION</h2>
                    ...
                    <input type="text" name='customerType' value={formData.customerType} onChange={handleInputChange} />
                    </div>
                    <div  className="input-group">
                    <label >Vehicle GCC Spesification</label>
                    <input type="text" name='vehicleGccSpesification' value={formData.vehicleGccSpesification} onChange={handleInputChange} />
                    </div>
                    <div  className="input-group">
                    <label >Type of Vehicle</label>
                    <input type="text" name='typeOfVehicle'value={formData.typeOfVehicle} onChange={handleInputChange} />
                    </div>
                    <div  className="input-group">
                    <label >Coverage Type</label>
                    <input type="text" name='coverageType' value={formData.coverageType} onChange={handleInputChange} />
                    </div>
                    <div  className="input-group">
                    <label >Purpose of transaction Type</label>
                    <input type="text" name='purposeOfTransaction' value={formData.purposeOfTransaction} onChange={handleInputChange} />
                    </div>
                </div>
                <div className="card">
                <h2 className='head'>VEHICLE INFORMATION</h2>
                    ...
                    <input type="text" name='modelYear' value={formData.modelYear} onChange={handleInputChange} />
                    </div>
                    <div  className="input-group">
                    <label >Make/Maufacturer</label>
                    <input type="text" name='makeMaufacturer' value={formData.makeMaufacturer} onChange={handleInputChange} />
                    </div>
                    <div  className="input-group">
                    ...
                    <input type="text" name='bodyType' value={formData.bodyType} onChange={handleInputChange} />
                    </div>
                    <div  className="input-group">
                    ...
                    <input type="text" name='cylinder' value={formData.cylinder} onChange={handleInputChange} />
                    </div>
                    <div  className="input-group">
                    <label >No of Seats</label>
                    <input type="text" name='noOfseats' value={formData.noOfseats} onChange={handleInputChange} />
                    </div>
                    <div  className="input-group">
                    <label >Manufactured Country</label>
                    <input type="text" name='manufacturedCountry' value={formData.manufacturedCountry} onChange={handleInputChange} />
                    </div>
                    <div  className="input-group">
                    <label >City of Registration</label>
                    <input type="text" name='cityOfRegistration' value={formData.cityOfRegistration} onChange={handleInputChange} />
                    </div>
                    <div  className="input-group">
                    <label >No Claim Discount(No. of years)</label>
                    <input type="text" name='noClaimDiscount' value={formData.noClaimDiscount} onChange={handleInputChange} />
                    </div>
                    <div  className="input-group">
                    <label >Vehicle Repair</label>
                    <input type="text" name='vehilcleRepair' value={formData.vehilcleRepair} onChange={handleInputChange} />
                    </div>
                    <div  className="input-group">
                    <label >Sum Insured</label>
                    <input type="text" name='sumInsured' value={formData.sumInsured} onChange={handleInputChange} />
                    </div>
                    </div>
                    <div className="card">
                <h2 className='head'>OWNER DETAILS</h2>
                    ...
                    <input type="text" name='ownersDateOfBirth' value={formData.ownersDateOfBirth} onChange={handleInputChange} />
                    </div>
                    <div  className="input-group">
                    <label >UAE Driving Licence Issue Date</label>
                    <input type="text" name='drivingLicenceIssueDate' value={formData.drivingLicenceIssueDate} onChange={handleInputChange} />
                    </div>
                    <div  className="input-group">
